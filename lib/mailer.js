...
<div style="font-family:Segoe UI,Arial,sans-serif;background:#f4f6f8;padding:30px 0">
  <div style="max-width:620px;margin:auto;background:#ffffff;border-radius:10px;
    ...
    <div style="padding:26px 28px;color:#333">
      ...
      <h2 style="margin:0 0 12px 0;color:#c47a2c;font-weight:600">
        RFQ Status Update
      </h2>
      ...
      <p style="font-size:15px;line-height:1.6;margin:0 0 18px 0;color:#555">
        ${statusMessage}
      </p>
      ...
      <p style="font-size:14px;color:#666;line-height:1.6;margin:0 0 22px 0">
        If you have any questions or need assistance, our team will be happy to help you.
      </p>

      <p style="font-size:14px;color:#444;margin:0">
        Warm regards,<br>
        <strong>Manik Trifaley Team</strong>
      </p>

    </div>

    <!-- FOOTER -->
    <div style="background:#fafafa;border-top:1px solid #eee;padding:14px 20px;
  ...
  <!-- DISCLAIMER -->
  <div style="max-width:620px;margin:auto;text-align:center;
              font-size:11px;color:#9aa0a6;margin-top:12px">
