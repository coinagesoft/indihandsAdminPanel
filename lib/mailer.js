...
export async function sendProposalNotificationEmail(to, clientName, proposalNumber, proposalDate, grandTotal, companyName) {
 const transporter = nodemailer.createTransport({
  host: "smtp.gmail.com",
  port: 465,
  secure: true,
  ...
  const htmlContent = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px;">
        ...
        <p style="color: #555; font-size: 16px;">
          Kindly log in to your account on our website to review the proposal and approve it at your earliest convenience.
        </p>
