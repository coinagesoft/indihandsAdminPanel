...
const Page = () => {
  ...
  <div className="table-responsive">
    ...
    >
      <colgroup>
        <col style={{ minWidth: "50px" }} />    {/* Sr No */}
        <col style={{ minWidth: "250px" }} />   {/* Description */}
        <col style={{ minWidth: "100px" }} />   {/* HSN/SAC */}
        <col style={{ minWidth: "60px" }} />    {/* UOM */}
        <col style={{ minWidth: "60px" }} />    {/* Qty */}
        <col style={{ minWidth: "100px" }} />   {/* Rate */}
        <col style={{ minWidth: "80px" }} />    {/* Discount */}
        <col style={{ minWidth: "120px" }} />   {/* Amount */}
        <col style={{ minWidth: "100px" }} />   {/* CGST */}
        <col style={{ minWidth: "100px" }} />   {/* SGST */}
        <col style={{ minWidth: "100px" }} />   {/* IGST */}
        <col style={{ minWidth: "140px" }} />   {/* Total */}
      </colgroup>
